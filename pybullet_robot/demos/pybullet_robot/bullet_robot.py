...
class BulletRobot(object):
    def __init__(self, description_path, uid=None, config=None, realtime_sim=False):
        ...
        pb.setGravity(0.0, 0.0, -10.0, physicsClientId=self._uid)
        if realtime_sim:
        ...
        print('ee link idx')
        print(self._ee_link_idx)
        self._joint_limits = self.get_joint_limits()

        self._ft_joints = [self._all_joints[-2]]
    ...
    def set_joint_velocities(self, cmd, joints=None):
        ...
        """
        print("I am actually in this velocity")
        if joints is None:
    ...
    def set_joint_torques(self, cmd, joints=None):
        ...
        #print("I am actually in this torque")
        if joints is None:
            joints = self._movable_joints
    ...
    def set_joint_positions_delta(self, cmd, joints=None, forces=None):
        ...
        """
        print("I am actually in this position delta")
        if joints is None:
            joints = self._movable_joints
    ...
    def set_joint_positions(self, cmd, joints=None, forces=None):
        ...
        """
        #print("I am actually in this position")
    ...
    def get_joint_limits(self):
        ...
        print({'lower': lower_lim, 'upper': upper_lim, 'mean': mean_, 'range': range_})   
