...
class PandaRobotiq140(RobotBase):
    def __init_robot__(self):
        # define the robot
        # see https://github.com/bulletphysics/bullet3/blob/master/examples/pybullet/gym/pybullet_robots/panda/panda_sim_grasp.py
        self.eef_id = 9
        self.arm_num_dofs = 7
        #self.arm_rest_poses = [0.98, 0.458, 0.31, -2.24, -0.30, 2.66, 2.32]
        #self.arm_rest_poses = [2.9769058137409696, -1.0859177266126032, 0.008183116443404671, -2.405814748290413, 0.027473054508285483, 1.6547323086439105, 2.980106640124731]
        self.arm_rest_poses = [1.57079632679, -1.0471975512, 0, -2.35619449019, 0, 1.57079632679, 3.14159265359]
        self.id = p.loadURDF('./urdf/franka_robotiq_140.urdf', self.base_pos, self.base_ori,
                             useFixedBase=True, flags=p.URDF_ENABLE_CACHED_GRAPHICS_SHAPES)
        self.gripper_range = [0, 0.085]
